...
| [Model Context Protocol](https://modelcontextprotocol.io/) | 寻找中 | [Search integration strategies](docs/comparisons/search-integration-strategies.md) | Explicit tool boundary; backend can be swapped; behavior is easier to audit than hidden retrieval. | Requires install scope, lifecycle, permissions, credentials, tool schema, and uninstall discipline. | <a href="https://code.claude.com/docs/"><code>Claude Code</code></a> <a href="https://modelcontextprotocol.io/"><code>MCP agents</code></a> |
...
| [Brave Search API](https://brave.com/search/api/) | 寻找中 | 调研中 | Managed web search API with a direct integration surface; useful when teams want less search infrastructure. | External provider trust, query policy, credentials, quota, cost, and source ranking must be evaluated. | <a href="https://developers.openai.com/codex/cloud"><code>Codex</code></a> <a href="https://code.claude.com/docs/"><code>Claude Code</code></a> <a href="https://openclaw.ai/"><code>OpenClaw</code></a> <a href="https://modelcontextprotocol.io/"><code>MCP agents</code></a> |
| [Tavily API](https://docs.tavily.com/api-reference/introduction) | 寻找中 | 调研中 | Agent-oriented API shape; useful for structured retrieval and productized search workflows. | Hosted dependency; cost, quota, data policy, and answer abstraction can reduce transparency. | <a href="https://developers.openai.com/codex/cloud"><code>Codex</code></a> <a href="https://code.claude.com/docs/"><code>Claude Code</code></a> <a href="https://openclaw.ai/"><code>OpenClaw</code></a> <a href="https://modelcontextprotocol.io/"><code>MCP agents</code></a> |
