...
Use this page as a public-safe launch kit for sharing Awesome Agent Search.
...
Repository: https://github.com/DeeeFOX/awesome-agent-search
...
This is an `awesome-*` style repository, not an `oh-my-*` installation bundle. The goal is to collect patterns that humans can review and AI agents can safely reuse.
...
仓库：https://github.com/DeeeFOX/awesome-agent-search
...
这是一个 `awesome-*` 风格仓库，不是 `oh-my-*` 安装包。目标是沉淀人类可审查、AI 可安全复用的搜索实践。

仓库：https://github.com/DeeeFOX/awesome-agent-search

## Suggested Channels

- GitHub profile or pinned repository
- X / LinkedIn
- Reddit communities focused on agents, local search, or developer tools
- Hacker News launch thread
- V2EX, Juejin, Jike, and technical WeChat groups

## Privacy Notes

- Do not include personal email addresses in launch posts.
- Do not mention private endpoints, local paths, internal deployments, or credentials.
- Link to public docs instead of pasting private setup details.
