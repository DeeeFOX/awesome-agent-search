...
| [DuckDuckGo Instant Answer API](https://duckduckgo.com/api) | 寻找中 | 调研中 | Instant Answer 风格 JSON 不需要 API key；适合轻量事实、实体查询和 fallback signal。 | 不是完整 web search results API；文档和维护可见性有限；没有 wrapper 和评估时不适合作为 coding-agent 主搜索后端。 | <a href="https://developers.openai.com/codex/cloud"><code>Codex</code></a> <a href="https://code.claude.com/docs/"><code>Claude Code</code></a> <a href="https://openclaw.ai/"><code>OpenClaw</code></a> <a href="https://modelcontextprotocol.io/"><code>MCP agents</code></a> |
